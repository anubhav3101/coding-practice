    ...
    def matrixSum(self, n, m, mat, q, queries):
        ...
        while q>0:
            ...
            if hop==1:
                ...
                lis=[(i-1,j-1),(i-1,j),(i-1,j+1),(i,j+1),(i+1,j+1),(i+1,j),(i+1,j-1),(i,j-1)]
                
            if hop==2:
                
                
                lis=[(i-2,j-2),(i-2,j-1),(i-2,j),(i-2,j+1),(i-2,j+2),(i-1,j+2),(i,j+2),(i+1,j+2),(i+2,j+2),(i+2,j+1),(i+2,j),(i+2,j-1),(i+2,j-2),(i+1,j-2),(i,j-2),(i-1,j-2)]
